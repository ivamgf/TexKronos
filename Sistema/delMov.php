...
<html>
    <head>
        ...
        <title>Exclusão de Movimentos</title>
...
//Bloco de código de conexão
     ...
     //Bloco de código de exclusão de movimentos
	 //Variáveis
	 $id_tmv = $_POST['id_tmv'];
	 ...
	 $excluir = mysql_query("DELETE from tabParSis_tps WHERE id_tmv = '$id_tmv' ") 
...
//Bloco de código de exclusão de movimentos	
        ...
        ?>
        <?php
        header("Location: delMovSist.html");
?>
    </body>
</html>